    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', backgroundColor: '#f0f0f0' }}>
            ...
            <form style={{ display: 'flex', flexDirection: 'column', width: '300px' }} onSubmit={handleLogin}>
                ...
                <input type="text" id="username" placeholder="Enter your username" style={{ marginBottom: '10px', padding: '8px' }} value={username} onChange={(e) => setUsername(e.target.value)} />
                <label htmlFor="password">Password:</label>
                <input type="password" id="password" placeholder="Enter your password" style={{ marginBottom: '20px', padding: '8px' }} value={password} onChange={(e) => setPassword(e.target.value)} />
